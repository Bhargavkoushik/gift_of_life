...
export default function DonorProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (secondaryPhone && secondaryPhone.trim()) {
      if (arePhonesEqual(primaryPhone, secondaryPhone)) {
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
          <div>
            ...
            <p className="text-xxs text-slate-500 font-medium mt-0.5">
              Update your password to keep your donor account protected.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-xxs text-slate-600 font-medium mt-0.5 max-w-md leading-relaxed">
                Permanently deactivate and delete your donor account. This action requires re-authentication and verification.
              </p>
            </div>
            <button
              type="button"
